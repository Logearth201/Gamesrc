...
MusicLoader.prototype.set = function(ma){
	try{
		...
		if(ma.isMusic || ma.isjingle){
			if(canPlayOgg){
				ma.musicobj.src = "fallfruit/bgm/" + ma.str + ".ogg";
			}else if(canPlayMp3){
				ma.musicobj.src = "fallfruit/bgm/" + ma.str + ".mp3";
			}else{
			...
			if(canPlayWav){
				ma.musicobj.src = "fallfruit/se/" + ma.str + ".wav";
			}else if(canPlayMp3){
				ma.musicobj.src = "fallfruit/se/" + ma.str + ".mp3";
			}else{
				ma.musicobj.error = true;
				return;
			}
